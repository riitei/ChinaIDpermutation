...
//    public void test() {
//
//        for (ID cid : chinaFemaleID) {
//            System.out.println("cid  " + cid.getID());
//        }
...
//    }
    ...
    public List<ID> getChinaIDs() {
        List<ID> chinaIDs = new ArrayList<>();
        chinaIDs.addAll(chinaFemaleID);
        chinaIDs.addAll(chinaMaleID);
    ...
    public List<ID> getChinaMaleIDs() {

        return chinaMaleID;
    }

    public List<ID> getChinaFemaleIDs() {
